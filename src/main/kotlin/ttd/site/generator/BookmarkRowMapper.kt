...
class BookmarkRowMapper : RowMapper<Bookmark> {
	...
	override fun mapRow(rs: ResultSet, i: Int): Bookmark {
		return Bookmark(rs.getLong("bookmark_id"), rs.getString("extended"), rs.getString("description"),
	...
	private fun arrayToCollection(ts: java.sql.Array): Collection<String> {
		return try {
